...
def preprocess_mof_data(data_path, split_method="maxsep", val_ratio=0.1, save_path=None):
    ...
    spec = onp.arange(1, scaled_dataset['species'].max() + 1)
...
def main():
    ...
    out_dir = train_utils.create_out_dir(config, tag="Qeq_Allegro_C_maxsep")
    dataset = preprocess_mof_data(data_path)
