...
def main():
    ...
    out_dir = train_utils.create_out_dir(config, tag="maxsep_dimnet")
    ...
    max_neighbors = int(max_neighbors * 1.15)
    max_edges = int(max_edges * 1.15)
