...
class AllegroEmbedding(hk.Module):
    ...
    def __init__(self,
        ...
        self.species_embedding = hk.Embed(num_species, embed_dim)
...
def allegro_qeq_neighborlist_pp(displacement: space.DisplacementFn,
    ...
    Args:
        ...
        exclude_electrostatics: Exclude electrostatics from the model.
    ...
    def model(position: md_util.Array,
        ...
        def _charge_eq_fn(gammas, chis, hardness):
            ...
            if allegro_kwargs.get("learn_radius", False):
