...
class MACE(hk.Module):
    def __init__(
        ...
        *,
        ...
        # Embeddings
        self.tc_embedding = hk.Embed(9, charge_embed_n_hidden)
    ...
    def __call__(
        ...
        for i in range(self.num_interactions):
            ...
            node_outputs, node_feats = MACELayer(
                ...
                tc_embedding=self.tc_embedding,
...
class MACELayer(hk.Module):
    def __init__(
        ...
        *,
        ...
        total_charge: int = 0,
        tc_embedding: callable = hk.Embed
        ...
        self.tc = total_charge
        self.tc_embedding = tc_embedding
    ...
    def __call__(
        ...
        sc = None
        species_emb = node_feats.filter(keep="0e").array
        ...
        debug.print("Embed: {}",self.tc_embedding(self.tc))
        
        refined_node_features = hk.Linear(self.num_features)(self.tc_embedding(self.tc))               # (N, num_features)
